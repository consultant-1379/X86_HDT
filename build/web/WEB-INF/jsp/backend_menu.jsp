...
<nav class="navbar navbar-default" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                    ...
                    <li role="presentation"><a  role="menuitem" tabindex="-1" href="${APPNAME}/product.htm">Product</a></li>
                        ...
                        <li role="presentation"><a  role="menuitem" tabindex="-1" href="${APPNAME}/app/app_type.htm">Hardware Type</a></li>
                    ...
                    <ul class="dropdown-menu sub-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu sub-menu">
                                    ...
                                    <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/delegate.htm?action=site&level=4">Site ID</a></li>
                        ...
                        <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/role/getAllRoleDescription.htm">Role Description</a></li>
                        <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/delegate.htm?action=role_visibilty&level=4">Role Visibility</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                    <li class="dropdown">
                        <a href="${APPNAME}/delegate.htm?action=delete_product_release&level=1">System Release </a>
                                <ul class="dropdown-menu sub-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/delegate.htm?action=copy_release&level=1">Hardware Bundle</a></li>
                    <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/delegate.htm?action=copy_network&level=2">App Number</a></li>
                    <li><a  role="menuitem" tabindex="-1" href="${APPNAME}/delegate.htm?action=copy_bundle&level=3">Bundle</a></li>
            </ul>
