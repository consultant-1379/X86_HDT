...
<html>
    <head>
        ...
        <script type="text/javascript" src="${APPNAME}/resources/js/hdt/systemBuildCheck.js"></script>
    </head>
        ...
        <button type="submit" class="btn btn-primary" id="note_submit_button">Save changes</button>
            ...
            <div class="row">
                ...
                <div id="parameter_content_ajax">
                    ...
                    <table class="table table-hover">
                            <tr><th><a href="#" onclick="toggleCheckBox(event,'name','parameters');">Toggle</a></th><th>Description</th><th>Name</th><th>Default Value</th></tr>
                                ...
                                <td>
                                        <c:choose>
                                                <c:when test="${par.parType.type!='BOOLEAN'}">
                                                    <input type="text" name="${par.name}" value="0"  class="form-control width80" size="2" onchange="autofill(this);" onblur="check_input(this);"/>
                                                </c:when>
                                                <c:when test="${par.parType.type=='BOOLEAN'}">
           ...
           <div id="role_content_ajax">  
               ...
               <table class="table table-hover">
                   ...
                   <tr>
                       <th><a href="#" onclick="toggleCheckBox(event,'name','roles');">Toggle</a></th>
                       <th>&nbsp;</th>
                       <th><a href="#" onclick="toggleCheckBox(event,'name','geo-red');">Toggle</a>
                           </th>
                       <th><a href="#" onclick="toggleCheckBox(event,'name','mand');">Toggle</a></th>
                       <th>&nbsp;</th>
                   </tr>
           ...
           <c:forEach items="${roles}" var="r">
               <tr>
                   ...
                   <td>${r.name}</td>
                   <td><input type="checkbox" class="toggleme" name="geo-red" value="${r.id}"  /></td>
