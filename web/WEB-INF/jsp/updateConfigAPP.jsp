            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Quantity Update Error</h4>
                    </div>
                                    ...
                                    <div class="panel-heading" role="tab">
                                        <h3 class="panel-title">
                                            ...
                                            <c:if test="${hw.assignToRole==true}">
                                                <img src="${APPNAME}/resources/images/green_tick.png" style="height:16px; width:20px;"/>
                                            </c:if>
                                        ...
                                        <div class="panel-body">
                                            <div class="form-group">
                                                <table class="table-condensed">
                                                    ...
                                                    <tr><th>APP Name</th><th>APP Description</th><th>QTY</th><th><img src="${APPNAME}/resources/images/blue-image.jpg" style="height:18px; width: 18px; border-radius: 12px; display: inline;" 
                                                                                                                          data-toggle="tooltip" data-placement="top" title="Setting Qty to 0, removed the App from the Hardware Bundle"/></th></tr>
