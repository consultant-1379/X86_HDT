     ...
     <c:if test="${count==2}">
                ...
                <c:if test="${count!=2}">
                    ...
                    <div class="tab-pane" id="${site.id}">
                        ...
                        <form method="post" action="rack/deleteRackComponent.htm"  name="deleteRackForm${site.id}" role="form">
   ...
   <div class="form-group">
        ...
        <table class="table-condensed">
            <tr>
                ...
                <th>Rack ID</th>
                <th><a href="#" onclick="toggleCheckBox(event,'form','deleteRackForm${site.id}');" >Toggle</a></th>
            </tr>
