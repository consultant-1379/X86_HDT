        ...
        <table class="table-condensed">
                ...
                <tr>
                    ...
                    <td><a href="#" onclick="getUserUniqueParameters('${parList.savedTime}');">
                                <img style="border-radius: 5px 5px 5px 5px; border: 0px;" src="${APPNAME}/resources/images/icon-view.png"> </a>
                    </td>
                    <td><a href="#" onclick="confirmDeleteUserParameterSet('${parList.savedTime}');">
                        <img style="border-radius: 8px 8px 8px 8px; border: 0px;" src="${APPNAME}/resources/images/delete_icon.png" /></a>
                    </td>
