<%-- 
    Document   : assignRoleHardware
    Created on : May 8, 2014, 9:28:51 PM
    Author     : eadrcle
--%>
         ...
         <div class="container-fluid">
                 ...
                 <div class="col-md-10">
                     ...
                     <form:form action="assign_role.htm" commandName="RoleForm" method="post" role="form" onsubmit="return checkHardwareBundle(this);">
                         ...
                         <table class="table-condensed">
                             ...
                             <tr>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="copyElementValue(event,'hardwareBundle');">Update All</a></th>
                                 <th><a href="#" onclick="copyElementValue(event,'revision');">Update All</a></th>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="copyElementValue(event,'expectResult');">Update All</a></th>
                                 <th>&nbsp;</th>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="toggleCheckBox(event,'name','defineAnotherRole');">Toggle</a></th>
                             </tr>
                 ...
                 <td>
                                     <select name="hardwareBundle" path="hardwareBundle" class="form-control">
                                            ...
                                            <c:forEach items="${hardwareBundles}" var="hwBundle" >
                                                 <option value="${hwBundle.id}">HW_CONF_<c:out value="${hwBundle.id}" /></option>
                
                                            </c:forEach>
                
                                    </select>
                 </td>                   
                 <td>                 <input type="text" name="revision"  value="" size="2" class="form-control" onchange="autofill(this);" onblur="check_input(this);" />
                 </td>
                 <td>
             ...
             data-toggle="tooltip" data-placement="top" title="Highest Revision is first Hardware to be shown"/>
                 ...
                 <td>
                     ...
                     <input type="text" name="expectResult" value="" size="2" class="form-control" 
                            onchange="autofill(this);" onblur="check_input(this);"/>
                                   
                 </td>  
                 <td><img src="${APPNAME}/resources/images/blue-image.jpg" style="height:18px; width: 18px; border-radius: 12px; display: inline;" 
             data-toggle="tooltip" data-placement="top" title="This is the expect result returned from the Formula for calculating the Hardware"/></td>
                 <td>
                                    <select name="notes" path="notes" class="form-control">notes
             ...
             <c:if test="${RoleForm.geoRoles!=null}" >
             ...
             <table class="table-condensed">
                 <tr>
                     ...
                     <th style="text-align: center;">Another Config</th></tr>
                 
                 <tr>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="copyElementValue(event,'geoHardwareBundle');">Update All</a></th>
                                 <th><a href="#" onclick="copyElementValue(event,'geoRevision');">Update All</a></th>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="copyElementValue(event,'expectResultGeo');">Update All</a></th>
                                 <th>&nbsp;</th>
                                 <th>&nbsp;</th>
                                 <th><a href="#" onclick="toggleCheckBox(event,'name','defineAnotherGeoRole');">Toggle</a></th>
                             </tr>
                         ...
                         <c:forEach items="${RoleForm.geoRoles}" var="role">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="geoRevision"  value="" size="2" class="form-control"
                                               onchange="autofill(this);" onblur="check_input(this);"/>
                                    </td>
                                    <td>
                                        <img src="${APPNAME}/resources/images/blue-image.jpg" style="height:18px; width: 18px; border-radius: 12px; display: inline;" 
             data-toggle="tooltip" data-placement="top" title="Highest Revision is first Hardware to be shown"/>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" name="expectResultGeo" value="" size="2" class="form-control"
                                               onchange="autofill(this);" onblur="check_input(this);"/>
                                    </td>
                                    <td>
